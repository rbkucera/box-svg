...
def generate_mailer_dieline(request: BoxRequest) -> Dieline:
    ...
    y_bottom_panel_top = y_dust_top - W
    y_front_panel_top = y_bottom_panel_top - H
    y_top_panel_top = y_front_panel_top - W
    y_tuck_top = 0.0
